        ...
        <div className="fs-footer-grid">
          ...
          <div className="fs-brand-col">
            ...
            <div className="fs-socials">
              <a href="https://www.tiktok.com/@everestacademy" target="_blank" rel="noreferrer" className="fs-social-icon">
              ...
              <a href="https://instagram.com/everestacademy" target="_blank" rel="noreferrer" className="fs-social-icon">
              ...
              <a href="https://t.me/everestacademy" target="_blank" rel="noreferrer" className="fs-social-icon">
