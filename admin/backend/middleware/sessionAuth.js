...
const publicPaths = ["/auth/login", "/auth/register", "/auth/forgot-password", "/auth/verify-otp", "/auth/reset-password", "/auth/heartbeat", "/admin-auth", "/public-upload", "/customer-service", "/pricing"];
