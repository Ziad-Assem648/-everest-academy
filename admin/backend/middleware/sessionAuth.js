...
const publicPaths = ["/auth/login", "/auth/register", "/auth/forgot-password", "/auth/verify-otp", "/auth/reset-password", "/auth/heartbeat", "/auth/resend-verification", "/auth/verify-email", "/admin-auth", "/public-upload", "/customer-service", "/pricing"];
